 ...
 *
 * Script: NovalnetPostfinanceCard.php
 *
 */
...
/**
 * Class NovalnetPostfinanceCard
 * @package Plugin\jtl_novalnet\paymentmethod
 */
class NovalnetPostfinanceCard extends Method
{     
    /**
     ...
     * @var string
     */
    private $paymentName = 'novalnet_postfinance_card';
    
    /**
     * NovalnetPostfinanceCard constructor.
     * 
    ...
    public function init(int $nAgainCheckout = 0): self
    {
        ...
        $this->name    = 'Novalnet PostFinance Card';
        $this->caption = 'Novalnet PostFinance Card';
    ...
    public function preparePaymentProcess(Bestellung $order): void
    {
        ...
        $paymentRequestData['transaction']['payment_type'] = 'POSTFINANCE_CARD';
