 ...
 *
 * Script: NovalnetPostfinance.php
 *
 */
...
/**
 * Class NovalnetPostfinance
 * @package Plugin\jtl_novalnet\paymentmethod
 */
class NovalnetPostfinance extends Method
{     
    /**
     ...
     * @var string
     */
    private $paymentName = 'novalnet_postfinance';
    
    /**
     * NovalnetPostfinance constructor.
     * 
    ...
    public function init(int $nAgainCheckout = 0): self
    {
        ...
        $this->name    = 'Novalnet PostFinance E-Finance';
        $this->caption = 'Novalnet PostFinance E-Finance';
    ...
    public function preparePaymentProcess(Bestellung $order): void
    {
        ...
        $paymentRequestData['transaction']['payment_type'] = 'POSTFINANCE';
