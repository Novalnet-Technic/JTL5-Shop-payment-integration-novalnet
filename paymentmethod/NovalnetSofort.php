...
/**
 * Class NovalnetSofort
 * @package Plugin\jtl_novalnet\paymentmethod
 */
class NovalnetSofort extends Method
{     
    /**
     ...
     * @var string
     */
    private $paymentName = 'novalnet_sofort';
    
    /**
     * NovalnetSofort constructor.
     * 
    ...
    public function preparePaymentProcess(Bestellung $order): void
    {
        ...
        $paymentRequestData['transaction']['payment_type'] = 'ONLINE_TRANSFER';
