 ...
 */
class NovalnetPrzelewy24 extends Method
{     
    /**
     ...
     * @var string
     */
    private $paymentName = 'novalnet_przelewy24';
    
    /**
     * NovalnetPrzelewy24 constructor.
     * 
    ...
    public function preparePaymentProcess(Bestellung $order): void
    {
        ...
        $paymentRequestData['transaction']['payment_type'] = 'PRZELEWY24';
