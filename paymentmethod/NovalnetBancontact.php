...
/**
 * Class NovalnetBancontact
 * @package Plugin\jtl_novalnet\paymentmethod
 */
class NovalnetBancontact extends Method
{     
    /**
     ...
     * @var string
     */
    private $paymentName = 'novalnet_bancontact';
    
    /**
     * NovalnetBancontact constructor.
     * 
    ...
    public function init(int $nAgainCheckout = 0): self
    {
        ...
        $this->name    = 'Novalnet Bancontact';
        $this->caption = 'Novalnet Bancontact';
    ...
    public function preparePaymentProcess(Bestellung $order): void
    {
        ...
        $paymentRequestData['transaction']['payment_type'] = 'BANCONTACT';
