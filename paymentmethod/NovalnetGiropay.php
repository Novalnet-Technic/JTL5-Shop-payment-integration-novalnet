 ...
 */
class NovalnetGiropay extends Method
{     
    /**
     ...
     * @var string
     */
    private $paymentName = 'novalnet_giropay';
    
    /**
     * NovalnetGiropay constructor.
     * 
    ...
    public function preparePaymentProcess(Bestellung $order): void
    {
        ...
        $paymentRequestData['transaction']['payment_type'] = 'GIROPAY';
